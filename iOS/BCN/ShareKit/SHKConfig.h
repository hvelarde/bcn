...
#define SHKMyAppName			@"BCN-Noticias"
#define SHKMyAppURL				@"http://www.guegue.info"
...
#define SHKFacebookKey				@"134050043356950"
#define SHKFacebookSecret			@"7aaeff94956e99fdd9f85274a18fe67d"
 ...
 */
#define SHKTwitterConsumerKey		@"VPx7Q2IBuCCBDRlKAgAw"
#define SHKTwitterSecret			@"bH2DsPkdIQtXaySJJiZHCdLp9N0uEbKRBxOUKQrf6c"
#define SHKTwitterCallbackUrl		@"http://dummy.bcn.guegue.info" // You need to set this if using OAuth, see note above (xAuth users can skip it)
...
#define SHKBitLyLogin				@"o_ik6n0jn72"
#define SHKBitLyKey					@"R_9f1f86dc7ab438395be830c82d05d6cd"
